...
export default function NotificationBell() {
  ...
  const handleMarkAllRead = async () => {
    try {
      ...
      setUnreadCount(0);
      await employeeApi.put('/employee-portal/ess/notifications/read-all');
    } catch {
      // silent
    }
  };
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 sm:w-96 max-h-[460px] flex flex-col bg-app-card border border-app-border rounded-2xl shadow-2xl z-50 overflow-hidden">
          {/* Header */}
