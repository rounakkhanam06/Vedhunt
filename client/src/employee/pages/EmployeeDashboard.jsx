...
const EmployeeDashboard = () => {
  ...
  const fetchStatsAndLogs = async (dateParam, pageParam) => {
    ...
    try {
      const statsRes = await employeeApi.get(`/employee-portal/ess/dashboard-stats?date=${targetDate}`);
  ...
  const handleRequestLeave = async (e) => {
    e.preventDefault();
    try {
      const res = await employeeApi.post('/employee-portal/ess/leave-requests', {
        leaveType,
