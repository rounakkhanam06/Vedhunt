  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-app-text">Home Services Header</h2>
          <p className="text-app-text-muted text-sm mt-1">Manage the header text for the "Our Expertise" section.</p>
        </div>
        <button
          ...
          <form onSubmit={handleHeaderSubmit} className="space-y-6 max-w-3xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-sm font-medium text-app-text">Tagline (Orange text)</label>
                <input
                  type="text"
                  name="tagline"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-app-text">Highlight Text (Orange part of heading)</label>
                <input
                  type="text"
                  name="highlightText"
