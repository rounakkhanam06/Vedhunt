        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {stats.map((stat, index) => (
            <motion.div 
              ...
              className="bg-app-card/30 backdrop-blur-xl border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 flex flex-col sm:flex-row items-center sm:items-center text-center sm:text-left justify-center sm:justify-start gap-2 sm:gap-4 group hover:border-primary/30 hover:bg-white/[0.03] transition-all duration-300 shadow-xl relative overflow-hidden"
            >
              ...
              <div className="space-y-0.5 sm:space-y-1 relative z-10">
                <div className="text-lg sm:text-2xl md:text-3xl font-bold font-heading text-white group-hover:text-primary transition-colors flex items-center justify-center sm:justify-start tracking-tight">
                  <Counter value={stat.value} suffix={stat.suffix} />
                </div>
                <div className="text-white/60 text-[9px] sm:text-[11px] font-semibold uppercase tracking-[0.05em] sm:tracking-[0.15em] leading-tight px-1 sm:px-0">
                  {stat.label}
                </div>
              </div>
            </motion.div>
